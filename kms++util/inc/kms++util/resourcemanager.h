...
public:
	...
	Plane* reserve_plane(Crtc* crtc, PlaneType typemask, PixelFormat format = PixelFormat::Undefined);
	Plane* reserve_plane(Crtc* crtc, PixelFormat format = PixelFormat::Undefined);
